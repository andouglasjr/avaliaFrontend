          ...
          <Flex className="portal-das-redacoes" margin={"130px 0"} width={"680px"} flexDir={"column"} justifyContent={"flex-start"} gap={"32px"}>
            ...
            <Flex gap={"16px"} flexDir={"column"}>
              <Flex alignItems={"flex-start"} gap={"16px"} alignSelf={"stretch"}>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>A persistência da violência contra a mulher na sociedade brasileira</Text></Flex>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"} >A ciência é a luz que ilumina as trevas da ignorância</Text></Flex>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>O estigma associado às doenças mentais na sociedade brasileira.</Text></Flex>
              </Flex>
              <Flex alignItems={"flex-start"} gap={"16px"} alignSelf={"stretch"}>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>Democratização do acesso ao cinema no Brasil</Text></Flex>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>Manipulação do comportamento do usuário pelo controle de dados na internet</Text></Flex>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>Desafios para a formação educacional de surdos no Brasil</Text></Flex>
              </Flex>
              <Flex alignItems={"flex-start"} gap={"16px"} alignSelf={"stretch"}>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>Caminhos para combater a intolerância religiosa no Brasil</Text></Flex>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>Publicidade infantil em questão no Brasil</Text></Flex>
                <Flex flex={"1 0 0"} padding={"16px"} borderRadius={"8px"} bgColor={neutralLight0}><Text textStyle={"Caption"} textAlign={"left"} height={"48px"} overflow={"hidden"} textOverflow={"ellipsis"}>Efeitos da implantação da Lei Seca no Brasil</Text></Flex>
              </Flex>
            </Flex>
          </Flex>
          <Box position={"relative"}>
            <Input borderColor={neutralLight2} paddingRight={"30px"} placeholder="Placeholder" width={"680px"} boxShadow={"0px 4px 6px 0px rgba(28, 31, 36, 0.16)"}/>
            <SendIcon position={"absolute"} top={"50%"} right={"10px"} transform={"translateY(-50%)"} color={neutralDark0} width={"24px"} height={"24px"}/>
          </Box>
